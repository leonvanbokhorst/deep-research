...
- **Critical infrastructure reconnaissance.** Germany's Federal Criminal Police Office recorded **1,072 incidents involving 1,955 drones in Germany in 2025**, mostly over military sites, airports, ports and defence firms, treated as surveillance or harassment rather than attacks. Notably, Dutch police DJI data logged **298 drone detections in 2023, of which only 55 were assessed as suspicious** — a low signal-to-noise ratio that is itself a caution against treating all sightings as threats. *(Grade A/C.)*
