...
**But the German institutional record also contains the strongest official caution found anywhere.** The **BfV's *Verfassungsschutzbericht 2025*** cautions against over-attributing hostile activity and against **overestimating Russian state capability**, speaks only of "**mutmaßliche** Drohnenüberflüge" (presumed drone overflights), and states that **"es gibt bisher keine Beweise"** — there is as yet no evidence — that Russian state bodies instrumentalised extremists for sabotage.

*(A source note: an earlier draft attributed the specific term "**Überattribution**" to the BfV. Research strands disagreed on whether that term appears as official BfV language, so it has been removed as a quotation. The substantive caution — the presumption language and the "no evidence yet" finding — is documented and stands.)* The **BKA's cybercrime report for 2025** states that **no police metrics on concrete AI use exist** ("Bislang liegen keine polizeilichen Kennzahlen zum konkreten KI-Einsatz… vor"). And there is open **institutional disagreement inside Germany**: the federal government's FAQ of 2 September 2026 says many drone flights "do not primarily aim at direct attacks, but at creating uncertainty", which sits awkwardly beside the Chancellor's public presumption of Russian responsibility.
