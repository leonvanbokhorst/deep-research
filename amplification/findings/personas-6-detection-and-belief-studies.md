...
- **Groh, Epstein, Firestone & Picard (2022, PNAS)** — **15,016 participants**, DFDC stimuli. Exp. 1 (2AFC, 882 analysed): **82% of individuals outperformed the leading model** (65% on the full holdout). Exp. 2: recruited participants **66%**, non-recruited **69%**, model **80%**; crowd mean **74%** recruited / **80%** non-recruited / **86%** for those seeing ≥10 videos. Machine-informed crowds improved **66%→73%** (P < .001), but **inaccurate model predictions decreased** accuracy. Accuracy fell **5.6 pp** for inverted face pairs (P = .004), **8.8%** with a person of dark skin present, and **1.1 pp per additional 10 s** of response time.
...
- **Diel, Bäuerle & Teufel** — feedback-based training improved accuracy **~20%** (n = 48 vs 48 control), but the training group showed **increased arousal and anxiety, decreased valence and negative affect, and decreased self-efficacy**. ⚠️ **Preprint.** Detection training carries a psychological cost that can undermine sustained participation.
- **Somoray & Miller (2023, *Computers in Human Behavior*)** and **Geissler, Robertson & Feuerriegel (2026, ACM CHI)** test explicit strategy/literacy interventions. ⚠️ CHI effect sizes not retrieved (publisher blocked).
...
- **Clark & Lewandowsky (2026, *Communications Psychology*)** — three preregistered experiments (N = 175, 275, 223). After a deepfake video of a crime/moral-transgression confession, sometimes preceded by an explicit warning, then guilt questions: **most participants relied on the video's content even when explicitly warned**, and **even among those who believed the warning and knew the video was fake**. The authors caution that task-framing explanations cannot be ruled out. **Transparency is insufficient.**
