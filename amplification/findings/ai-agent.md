...
**OpenAlex:** HTTP 429, daily budget exhausted for this IP — unusable [HIGH]. **Semantic Scholar:** HTTP 429 throughout — unusable [HIGH]. **arXiv:** works but IP-rate-limits after 2–4 requests — partial; some phrases UNVERIFIED [MED]. **Crossref** and **Europe PMC:** working (Crossref = titles/metadata only) [HIGH]. **DuckDuckGo / Brave / Bing / Mojeek:** bot-blocked or degraded, so there is **no reliable web-wide phrase search**, making non-scholarly "NOT FOUND" weaker evidence [MED].
...
| **"threat amplification"** | **EXISTS, incidental** | arXiv 2: *Cascade: Composing Software-Hardware Attack Gadgets for Adversarial Threat Amplification in Compound AI Systems* (arXiv:2603.12023, 2026); *Safety in Self-Evolving LLM Agent Systems* (arXiv:2606.23075, 2026). Not a defined attack class. |
| **"amplification attack"** (AI sense) | **EXISTS, partly AI** | arXiv 21, incl. ***SkillBloat: Token Amplification Attacks via Skill Injection in LLM Coding Agents***. Crossref 21 titles are classic DDoS (DNS/NTP/TFTP) plus *Blockchain Amplification Attack* (2025). |
...
| **"self-amplifying threat"** | **NOT FOUND** | arXiv 0; Crossref 0 titles. |
...
| **"reaction force multiplication"** | **NOT FOUND** | arXiv 0; Crossref 0 titles. |
...
| **"target-operated attack" / "victim-operated"** | **NOT FOUND** | arXiv 0; Crossref 0 titles. |
...
| **"AI-generated emergency misinformation"** | **NOT FOUND** | arXiv 0; Crossref 0 titles. No dedicated term. |
| **"AI-generated panic"** | **NOT FOUND** | arXiv 0; Crossref 0 titles. |
...
| **"LLM-driven social engineering"** | **EXISTS (2025)** | arXiv 2: *SEAR: A Multimodal Dataset for Analyzing AR-LLM-Driven Social Engineering Behaviors* (arXiv:2505.24458); *On the Feasibility of Using MultiModal LLMs to Execute AR Social Engineering Attacks* (arXiv:2504.13209). |
...
| **"AI-driven reflexive control"**, **"AI-triggered mass reaction"**, **"cognitive reflection attack"**, **"information amplification attack"**, **"narrative DDoS"**, **"semantic DDoS"** | **NOT FOUND** | arXiv 0 (verified for first three) / Crossref 0. |
...
- **OWASP LLM Top 10 2025** (https://genai.owasp.org/llm-top-10/): Prompt Injection, Sensitive Information Disclosure, Supply Chain, Data & Model Poisoning, Improper Output Handling, Excessive Agency, System Prompt Leakage, Vector & Embedding Weaknesses, Misinformation, Unbounded Consumption. **Amplification not named**; nearest are Misinformation/Unbounded Consumption. Agentic resource: https://genai.owasp.org/resource/agentic-ai-threats-and-mitigations/ [HIGH]
