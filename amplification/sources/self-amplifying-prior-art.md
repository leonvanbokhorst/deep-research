...
**The negative evidence is the most important result.** Internet Archive full-text search returns **NO RESULTS** for: "self-amplifying attack," "reaction force multiplication," "social amplification attack," "weaponised overreaction," "autonomous narrative warfare," "agentic influence operations," and "cognitive amplification attack." arXiv and Crossref (via a parallel search) return **zero** for "**agentic threat amplification**," "self-amplifying threat," "reaction force multiplication," "target-operated attack," "cognitive amplification attack," "informational reflection attack," "narrative amplification attack," "AI-driven reflexive control," "AI-generated emergency misinformation" and "AI-generated panic."

**But some near-misses DO exist, and must be acknowledged.**
- **"Threat amplification"** is already used in 2026 agent-safety papers — *Cascade: Composing Software-Hardware Attack Gadgets for Adversarial Threat Amplification in Compound AI Systems* (arXiv:2603.12023) and *Safety in Self-Evolving LLM Agent Systems: Threats, Amplification, and Case Studies* (arXiv:2606.23075). Neither defines an attack class; both use the phrase incidentally. **M.**
- **"Self-amplifying attack"** appears once, incidentally: *RunawayEvil: Jailbreaking the Image-to-Video Generative Models* (arXiv:2512.06674). **M.**
- **MITRE ATLAS `AML.T0034 "Cost Harvesting"`** (sub-technique `.002 Agentic Resource Consumption`) is the closest **named** AI-era pattern: the attacker induces the target system to "trigger autoscaling mechanisms that provision additional resources, further **amplifying** cost and exposure." That is a small-input → disproportionate-target-cost pattern — but framed as resource/cost abuse, **not** as the target's self-inflicted overreaction. **H.**
- **"Agentic influence operations"** exists as of 2026 (*Execution and Assessment of Agentic Influence Operations in Simulated Social Networks*, IEEE S&P, doi:10.1109/msec.2026.3725886); **"AI-enabled influence operations"** likewise (doi:10.2139/ssrn.6574547). **H**/*M*.

**Taxonomies checked, with results.** MITRE ATLAS contains no "amplification"/"reflection"/"reflexive"/"cascade" **technique**; its nearest entries are Cost Harvesting and **AML.T0061 "LLM Prompt Self-Replication"** (**H**). **OWASP LLM Top 10 (2025)** names no amplification pattern (nearest: LLM09 Misinformation, LLM10 Unbounded Consumption). **NIST AI 100-2e2025** uses the Availability/Integrity/Privacy/Misuse taxonomy; "amplif*" appears only in technical senses, "cascad*" and "reflexiv*" zero — **the pattern is not named**. The **International AI Safety Report 2026** is descriptive only ("errors can propagate and amplify through agent interactions"). OpenAI's frontier framework uses "could amplify existing pathways to severe harm" as a *capability threshold*, not a taxonomy. All **H**.

**What else exists:** "algorithmic amplification" — "increases in the distribution or visibility of content on digital platforms, arising from a combination of automated ranking by recommendation systems and users' own sharing" (https://en.wikipedia.org/wiki/Algorithmic_amplification, **H**) — extended to agents by Chirag Shah, *Agentic Algorithmic Amplification and the Choices We Face* (SSRN 2025), doi:10.2139/ssrn.5925582 (**H** via Crossref). That is *platform* amplification, not adversary-engineered target self-harm. Anthropic's September 2026 threat-intelligence report is the key first-party datum for the *capability* claim (8,913 articles in ~20 languages; "most of the content we discovered drew little or no authentic engagement"): https://www.anthropic.com/threat-intelligence-report-september-2026 (**H**).
...
| MITRE ATLAS "Cost Harvesting" (AML.T0034) | **yes** | partial (target's own autoscaling) | **yes** |
| "Threat amplification" (2026 agent papers) | yes | partial | **yes** |
