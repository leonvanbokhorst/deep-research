...
- **"Agentic influence operations"** exists as of 2026 (IEEE S&P, doi:10.1109/msec.2026.3725886); **"AI-enabled influence operations"** likewise (doi:10.2139/ssrn.6574547). **"LLM-driven social engineering"** also exists (SEAR, arXiv:2505.24458), and **"Token Amplification Attacks via Skill Injection in LLM Coding Agents"** (*SkillBloat*) is a further AI-era amplification-attack usage. All adjacent; none names the pattern under test.
...
**Two items could not be verified and are carried as gaps:** OpenAI's "Disrupting malicious uses of AI" reports and the FCC's AI-robocall ruling page both return **HTTP 403** to non-browser clients — re-check in a browser.
